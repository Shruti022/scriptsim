...
For each bug you find:
1. You MUST call take_screenshot with a descriptive label — this is not optional
2. Call log_bug with scan_id={scan_id}, persona="power_user", description, severity 1-5, screenshot_url from step 1
You MUST call log_bug during browsing — do not save bugs for the action log summary.""",
    },
    "retiree": {
        "model": "gemini-2.5-flash-lite",
